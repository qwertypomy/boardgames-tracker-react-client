...
export class BoardField extends React.Component {
  render () {
    ...
    const fieldNameInterface = isCreator && isEditing? (
      <div className="board-field small-4 columns">
    ...
    ) : <div className="board-field small-4 columns"><p>{fieldName}</p></div>;
    ...
    const fieldValueInterface = ((isCreator || !isPrivate) && !isLocked) ||
      ...
      ): <div className="board-field small-4 columns"><p>{fieldValue}</p></div>;
